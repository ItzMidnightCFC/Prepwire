export function jambbody(body) {
  body.innerHTML = `<h1 class="questtext" id='red' >JAMB Practice Preference </h1>
...
`;
  ...
  startbtn.onclick = () => {
    ...
    sessionStorage.setItem("jsubject", savesubject);
    sessionStorage.setItem("jsnq", savenquest);
    sessionStorage.setItem("jtime", savetime);
    sessionStorage.setItem("jtsubject", savesubjecttext);
    sessionStorage.setItem("JexamType", "JAMB");

    window.open("../../Practice/JAMB", "_blank");
  };
}
