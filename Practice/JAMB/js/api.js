...
const jtime = sessionStorage.getItem("jtime");
const JexamType = sessionStorage.getItem("JexamType");
...
const API_URL = `https://questions.aloc.com.ng/api/v2/q?subject=${jsubject}&type=UTME&limit=${jsnq}`;
...
async function loadQuestions() {
  try {
    ...
    const questionCount = Number(jsnq);
...
function timebox() {
  ...
  const totalMinutes = Number(jtime);
